...
public class Stepdefs {
    ...
    public void aValidUsernameAndInvalidPasswordWithMatchingPasswordAreEnteredTooShort(String username, String password) {
        createAccountWith(username, password, password);
    }

    @When("a valid username {string} and password {string} and not matching password {string} are entered")
    public void nonMatchingConfirmation(String username, String password, String otherpassword) {
        createAccountWith(username, password, otherpassword);
    }
    ...
    private void createAccountWith(String username, String password, String otherpassword) {
        ...
        element.sendKeys(otherpassword);
